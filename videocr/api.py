...
def get_subtitles(
        ...
        conf_threshold=65, sim_threshold=90, box=2, frame_skip=0, brightness_threshold=None, verbose=False) -> str:
    utils.download_lang_data(lang, verbose)

    v = Video(video_path)
    v.run_ocr(lang, time_start, time_end, conf_threshold, box, frame_skip, brightness_threshold, verbose)
